...
def mode_6():
    ...
    plt.title(
        "6. US people with dem/repub/ind AND ben-recoded parties {}".format(str(corr)))
    plt.ylabel(
        'Self-Reported Political Alignment (0 is liberal, 7 is conservative)')
...
def mode_5():
    ...
    corr = np.corrcoef(parties, alignments)[0, 1]
    plt.title(
        "5. ALL people with dem/repub/ind AND ben-recoded GLOBAL parties {}".format(str(corr)))
    plt.ylabel(
        'Self-Reported Political Alignment (0 is liberal, 7 is conservative)')
    plt.xlabel('Our Alignment Scores (-1 is very liberal, 1 is very conservative)')
    plt.scatter(alignments, parties)
...
def mode_4():
    ...
    corr = np.corrcoef(parties, alignments)[0, 1]
    plt.title(
        "4. ALL people with dem/repub AND ben-recoded GLOBAL parties {}".format(str(corr)))
    plt.ylabel(
        'Self-Reported Political Alignment (0 is liberal, 7 is conservative)')
    plt.xlabel('Our Alignment Scores (-1 is very liberal, 1 is very conservative)')
    plt.scatter(alignments, parties)
...
def mode_3():
    ...
    corr = np.corrcoef(parties, alignments)[0, 1]
    plt.title(
        "3. US people with dem/repub AND ben-recoded parties {}".format(str(corr)))
    plt.ylabel(
        'Self-Reported Political Alignment (0 is liberal, 7 is conservative)')
    plt.xlabel('Our Alignment Scores (-1 is very liberal, 1 is very conservative)')
    plt.scatter(alignments, parties)
