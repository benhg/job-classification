...
def create_subnet(vpc):
    ...
    # Assign IPv6 block for subnet using CIDR provided by Amazon, except
    # different size (must use /64)
...
def config_route_table(vpc, internet_gateway):
    ...
    route_ig_ipv6 = route_table.create_route(
