...
print("Problem 6.9 A. Analytic part done on paper. First 20 eigenvalues printed below")
print(energy)
...
i = 0
for t in linspace(0, 1.1269939220108039e-16, NUM_FRAMES):
    generate(t)
    i += 1
...
fig = plt.figure()
ani = animation.ArtistAnimation(fig, img, interval=150, blit=True,
                                repeat_delay=1000)
