...
def solar_system_rk4(r0, v0, f1, f2, f3, f4, tmax):
    ...
    for t in tpoints:
        ...
        m2 = h*f3(x + k1/2, y+l1/2, vx+m1/2, vy+n1/2, t+h/2)
        n2 = h*f4(x + k1/2, y+l1/2, vx+m1/2, vy+n1/2, t+h/2)
        k3 = h*f1(x + k2/2, y+l2/2, vx+m2/2, vy+n2/2, t+h/2)
        l3 = h*f2(x + k2/2, y+l2/2, vx+m2/2, vy+n2/2, t+h/2)
        m3 = h*f3(x + k2/2, y+l2/2, vx+m2/2, vy+n2/2, t+h/2)
        n3 = h*f4(x + k2/2, y+l2/2, vx+m2/2, vy+n2/2, t+h/2)
...
xpts, ypts, vxpts, vypts, tpts = solar_system_rk4(1, 2*pi, f1, f2, f3, f4, 100)
plot(xpts, ypts, )
show()
