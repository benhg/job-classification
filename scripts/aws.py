...
class EC2Provider(ExecutionProvider):
    ...
    def scale_out(self, size, cmd_string=None):
        ...
        self.logger.info("started {} instances".format(
    ...
    def spin_up_instance(self, cmd_string):
        ...
        command = template_string + \
            "\n{}\n{}".format(
                self.ipyparallel_configuration(), escaped_command)
...
ipengine --file=ipengine.json &>> .ipengine_logs/$jobname.log""".format(config)
        return ipptemplate
